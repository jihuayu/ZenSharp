...
public class TestFunctionTypesInSignatures {
    ...
    public void TestFunctionExpressionInStaticFunction() {
        ...
        TestAssertions.assertMany("Hello World", "hello from inside myAcceptFun", "Another thing: hello from inside myAcceptFun");
    }
    ...
    public void TestFunctionExpressionInClassSignature() {
        ...
        TestAssertions.assertMany("inside fun: abc");
    }
}
