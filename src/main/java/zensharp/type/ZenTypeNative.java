...
import zensharp.expression.*;
import zensharp.type.casting.CastingNotNull;
...
import zensharp.type.iterator.IteratorIterable;
import zensharp.type.iterator.IteratorList;
import zensharp.type.iterator.IteratorMap;
import zensharp.type.iterator.IteratorMapKeys;
import zensharp.type.natives.*;
import zensharp.util.*;
...
import static zensharp.util.AnyClassWriter.throwCastException;
...
public class ZenTypeNative extends ZenType {
    ...
    public String getSignature() {
        return ZenTypeUtil.signature(cls);
    }
    ...
    private class AnyNativeDefinition implements IAnyDefinition {
        ...
        public void defineMembers(ClassVisitor output) {
            ...
            MethodOutput valueOf = new MethodOutput(output, Opcodes.ACC_PUBLIC | Opcodes.ACC_STATIC, "valueOf", "(F)" + ZenTypeUtil.signature(IAny.class), null, null);
            valueOf.start();
        ...
        public void defineNot(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "not");
            /*
        ...
        public void defineNeg(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "negate");
        }
        
        @Override
        public void defineAdd(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "+");
        }
        ...
        public void defineCompareTo(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "compare");
        }
        
        @Override
        public void defineContains(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "in");
        }
        
        @Override
        public void defineMemberGet(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "member get");
        }
        
        @Override
        public void defineMemberSet(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "member set");
        }
        
        @Override
        public void defineMemberCall(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "member call");
        }
        
        @Override
        public void defineIndexGet(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "index get");
        }
        
        @Override
        public void defineIndexSet(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "index set");
        }
        
        @Override
        public void defineCall(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "call");
        }
        
        @Override
        public void defineAsBool(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "asBool");
        }
        
        @Override
        public void defineAsByte(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "asByte");
        }
        
        @Override
        public void defineAsShort(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "asShort");
        }
        
        @Override
        public void defineAsInt(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "asInt");
        }
        
        @Override
        public void defineAsLong(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "asLong");
        }
        
        @Override
        public void defineAsFloat(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "asFloat");
        }
        
        @Override
        public void defineAsDouble(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "asDouble");
        }
        
        @Override
        public void defineAsString(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "asString");
        }
        
        @Override
        public void defineAs(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "as");
        }
        
        @Override
        public void defineIs(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "is");
        }
        ...
        public void defineIteratorSingle(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "iterator");
        }
        ...
        public void defineEquals(MethodOutput output) {
            // TODO: implement
            AnyClassWriter.throwUnsupportedException(output, getName(), "equals");
        }
