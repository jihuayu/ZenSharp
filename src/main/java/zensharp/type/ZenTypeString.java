...
public class ZenTypeString extends ZenType {
    ...
    private class AnyDefinitionString implements IAnyDefinition {
        ...
        public void defineMembers(ClassVisitor output) {
            ...
            MethodOutput valueOf = new MethodOutput(output, Opcodes.ACC_PUBLIC | Opcodes.ACC_STATIC, "valueOf", "(Ljava/lang/String;)" + ZenTypeUtil.signature(IAny.class), null, null);
            valueOf.start();
        ...
        public void defineCat(MethodOutput output) {
            ...
            output.invokeStatic(ANY_NAME, "valueOf", "(Ljava/lang/String;)" + ZenTypeUtil.signature(IAny.class));
            output.returnObject();
        }
