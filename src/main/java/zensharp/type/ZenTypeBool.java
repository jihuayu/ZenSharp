...
public class ZenTypeBool extends ZenType {
    ...
    private class AnyDefinitionBool implements IAnyDefinition {
        ...
        public void defineMembers(ClassVisitor output) {
            ...
            MethodOutput valueOf = new MethodOutput(output, Opcodes.ACC_PUBLIC | Opcodes.ACC_STATIC, "valueOf", "(Z)" + ZenTypeUtil.signature(IAny.class), null, null);
        ...
        private void valueOf(MethodOutput output) {
            output.invokeStatic(ANY_NAME, "valueOf", "(Z)" + ZenTypeUtil.signature(IAny.class));
        }
    }
}
