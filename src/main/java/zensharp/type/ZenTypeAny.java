...
import zensharp.util.AnyClassWriter;
...
public class ZenTypeAny extends ZenType {
    ...
    public Expression unary(ZenPosition position, IEnvironmentGlobal environment, Expression value, OperatorType operator) {
        switch(operator) {
            case NEG:
                return new ExpressionCallVirtual(position, environment, AnyClassWriter.METHOD_NEG, value);
            case NOT:
                return new ExpressionCallVirtual(position, environment, AnyClassWriter.METHOD_NOT, value);
            default:
