...
public class MethodOutput {
    ...
    public void newArray(Class componentType) {
        ...
        visitor.visitTypeInsn(NEWARRAY, ZenTypeUtil.internal(componentType));
    }
    ...
    public void checkCast(Class newClass) {
        ...
        visitor.visitTypeInsn(CHECKCAST, ZenTypeUtil.signature(newClass));
    }
    ...
    public void invokeStatic(Class owner, String name, Class result, Class... arguments) {
        ...
        descriptor.append(')');
        descriptor.append(result == null ? 'V' : ZenTypeUtil.signature(result));
        
        if(debug)
            System.out.println("invokeStatic " + ZenTypeUtil.internal(owner) + '.' + name + descriptor);
        
        visitor.visitMethodInsn(INVOKESTATIC, ZenTypeUtil.internal(owner), name, descriptor.toString(), false);
    }
    ...
    public void invokeVirtual(Class owner, String name, Class result, Class... arguments) {
        ...
        visitor.visitMethodInsn(INVOKEVIRTUAL, ZenTypeUtil.internal(owner), name, descriptor.toString(), false);
    }
    ...
    public void invokeInterface(Class owner, String name, Class result, Class... arguments) {
        ...
        visitor.visitMethodInsn(INVOKEINTERFACE, ZenTypeUtil.internal(owner), name, descriptor.toString(), true);
    }
    ...
    public void newObject(Class type) {
        ...
        visitor.visitTypeInsn(NEW, ZenTypeUtil.internal(type));
    }
    ...
    public void construct(Class type, Class... arguments) {
        ...
        visitor.visitMethodInsn(INVOKESPECIAL, ZenTypeUtil.internal(type), "<init>", descriptor.toString(), false);
    }
    ...
    public void getField(Class owner, String name, Class descriptor) {
        ...
        visitor.visitFieldInsn(GETFIELD, ZenTypeUtil.internal(owner), name, ZenTypeUtil.signature(descriptor));
    }
    ...
    public void putField(Class owner, String name, Class descriptor) {
        ...
        visitor.visitFieldInsn(PUTFIELD, ZenTypeUtil.internal(owner), name, ZenTypeUtil.signature(descriptor));
    }
    ...
    public void getStaticField(Class owner, Field field) {
        ...
        visitor.visitFieldInsn(GETSTATIC, ZenTypeUtil.internal(owner), field.getName(), ZenTypeUtil.signature(field.getType()));
    }
    ...
    public void putStaticField(Class owner, Field field) {
        ...
        visitor.visitFieldInsn(PUTSTATIC, ZenTypeUtil.internal(owner), field.getName(), ZenTypeUtil.signature(field.getType()));
    }
