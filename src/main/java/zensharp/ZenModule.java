...
public class ZenModule {
    ...
    public static void compileScripts(String mainFileName, List<ZenParsedFile> scripts, IEnvironmentGlobal environmentGlobal, boolean debug) {
        ...
        clsMain.visit(Opcodes.V1_8, Opcodes.ACC_PUBLIC, "__ZenMain__", null, ZenTypeUtil.internal(Object.class), new String[]{ZenTypeUtil.internal(Runnable.class)});
        ...
        for(ZenParsedFile script : scripts) {
            ...
            clsScript.visit(Opcodes.V1_8, Opcodes.ACC_PUBLIC, script.getClassName().replace('.', '/'), null, ZenTypeUtil.internal(Object.class), new String[]{ZenTypeUtil.internal(Runnable.class)});
